...
wireless relation. In the present study, the layer set $\mathcal{L}$ consists
of association competition, interference similarity, load-pressure similarity,
and temporal traffic similarity. A layer-aware GNN then learns separate graph
filters over these relation layers before fusing the resulting embeddings for
...
\begin{figure*}[!t]
    \centering
    \includegraphics[width=\textwidth]{figures/fig_multilayer_ua_model.png}
